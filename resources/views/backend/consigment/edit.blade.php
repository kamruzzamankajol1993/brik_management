...
<!-- end page title -->
<form action="{{ route('admin.consigment.update') }}" method="post" >
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row mt-2">
                        <label for="" class="col-sm-4 col-form-label">Select Truck</label>
                        <div class="col-sm-8">
                            <select name="select_truck" id="select_truck" class="form-control">
                                <option value="">-- Please Select --</option>
                                @foreach($car_and_driver_lists as $all_car_and_driver_lists)
                                <option value="{{ $all_car_and_driver_lists->car_number }}" {{ $consigment_detail->select_truck == $all_car_and_driver_lists->car_number ? 'selected':''}}>{{ $all_car_and_driver_lists->car_number }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div id="get_all_informationt">
                    <div class="form-group row mt-2">
                        <label for="" class="col-sm-4 col-form-label">Driver</label>
                        <div class="col-sm-8">
                            <input class="form-control" type="text" name="driver_name" value="{{ $consigment_detail->driver_name }}" id="driver_name">
                        </div>
                    </div>
                    ...
                    <div class="form-group row mt-2">
                        <label for="" class="col-sm-4 col-form-label">Contact No</label>
                        <div class="col-sm-8">
                            <input class="form-control" type="text" value="{{ $consigment_detail->driver_contact }}" name="driver_contact" id="driver_contact">
                        </div>
                    </div>
                    </div>
