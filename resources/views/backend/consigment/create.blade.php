...
<!-- end page title -->
<form action="{{ route('admin.consigment.store') }}" method="post" >
    @csrf
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-sm-8">
                            <select name="select_truck" id="select_truck" class="form-control">
                                ...
                                <option value="{{ $all_car_and_driver_lists->car_number }}">{{ $all_car_and_driver_lists->car_number }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-sm-8">
                            <input class="form-control" type="text" name="driver_name" id="driver_name">
                        </div>
                    </div>
                    ...
                    <div class="form-group row mt-2">
                        <label for="" class="col-sm-4 col-form-label">Contact No</label>
                        <div class="col-sm-8">
                            <input class="form-control" type="text" name="driver_contact" id="driver_contact">
                        </div>
                    </div>
                    </div>
