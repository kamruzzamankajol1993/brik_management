...
success: function(data) {
  ...
  $("#search_area").html(data);
    ...
    $("#final_result_button").click(function(){
        ...
        $.ajax({
url: "{{ route('vendorReport_monthly_search_result_to_get_data') }}",
method: 'GET',
...
if(search_type =='yearly'){
    ...
    $.ajax({
url: "{{ route('vendorReport_yearly_search_result_to_get_data') }}",
method: 'GET',
...
if(search_type =='datewise'){
   ...
   $.ajax({
url: "{{ route('vendorReport_datewise_search_result_to_get_data') }}",
method: 'GET',
